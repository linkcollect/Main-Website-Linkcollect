        ...
        <div className="flex flex-col items-center justify-center w-full gap-3">
          ...
          <div className="w-[100%]">
            <div className="flex items-center justify-between w-full">
              ...
              <small className={`text-xs ${selectedMode === 'light' ? "" : "text-neutral-300"} `}>
                <span
                  className={`${collectionData.title?.length > 40
                    ? "text-error-500" 
                    : ""
                    }`}
                >
          ...
          <div className="w-full">
            <div className="flex items-center justify-between w-full">
              ...
              <small className={`text-xs ${selectedMode === 'light' ? "" : "text-neutral-300"} `}>
                <span
                  className={`${collectionData.description?.length > 240
                    ? "text-error-500"
                    : ""
                    }`}
                >
          ...
          <div className="flex items-center justify-between w-full">
            <p className={`${selectedMode === "light"? "text-neutral-700" : "text-neutral-50" } `}>Select Privacy</p>
            {/* Switch */}
            <div
              className={`flex relative items-start justify-center gap-1.5 p-1 w-40 sm:w-40 h-[32px] ${selectedMode === "light"? "border-neutral-300 bg-neutral-300" : "border-dark-border bg-dark-secondary"  } border-2 rounded-[100px]`}
            >
              <div
                className={`relative z-10 rounded w-1/2 h-full cursor-pointer transition-all duration-300 py-1.5 px-2.5 flex items-center justify-center ${selectedMode==="light"? !collectionData.isPublic ? "text-white" : "text-black" : "text-white"
              ...
              <div
                className={`relative z-10 rounded text-sm sm:text-base w-1/2 h-full cursor-pointer transition-all duration-300 py-1.5 px-2.5 flex items-center justify-center ${selectedMode==="light"? collectionData.isPublic ? "text-white" : "text-black" : "text-white"
                  }  font-normal`}
              ...
              <div
                className={`absolute w-[49%] h-[85%] transition-transform duration-200 top-1/2 -translate-y-1/2 left-0 rounded-[102px] z-[1]  bg-primary-500 ${!collectionData.isPublic
                  ? "translate-x-[5%]"
                  : "translate-x-[100%]"
                  }`}
              ></div>
