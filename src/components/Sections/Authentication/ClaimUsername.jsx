      ...
      <div className="flex flex-col items-center justify-center mt-[-32px]">
        <div className="rounded-2xl flex items-center justify-evenly flex-col bg-bgPrimary gap-6 p-10 w-[410px] height[600px]">
          ...
          <div className="flex flex-col items-center justify-center w-full gap-1">
            <h1 className=" text-[40px] leading-[50px] text-neutral-900 font-bold lexend whitespace-nowrap">
              Claim Username
            </h1>
          ...
          <div className="flex flex-col items-center justify-center w-full gap-6">
            <div className="relative w-full">
              ...
              {!isValid && claimedUsername.length > 0 && (
                <small className="absolute left-0 font-medium -bottom-5 text-danger">
                  * Username not available
                </small>
              )}
            </div>
            <button
              className={`flex items-center justify-center w-full py-3 font-bold rounded-lg ${
                claimedUsername.length > 1 ? 'bg-primary-500' : 'bg-neutral-400'
              } text-white`}
            >
              Continue
            </button>
