    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="px-3 flex flex-col gap-5">
        ...
        <div>
          ...
          {selectedCollection !== '' && (
            <p className="w-full mt-3 text-neutral-700">{`Move ${numberOfSelectedLinkes} links from ${nameOfTheCollection} collection to ${selectedCollection}`}</p>
          )}
        </div>

        {/* Actions */}
        <div className="flex w-full sm:justify-between justify-evenly items-center">
          <button className="flex items-center justify-center w-[45%] sm:w-[48%] h-12 rounded-xl bg-neutral-100 px-3 py-6 font-medium text-[16px] border-2 border-primary-500 text-primary-500 cursor-pointer">
            <span>Move</span>
          </button>
          <button
