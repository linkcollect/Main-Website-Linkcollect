...
const HeroSection = () => {
    ...
    return (
        <>
            ...
            <a href='https://docs.google.com/forms/d/e/1FAIpQLSdw2m4_JDB0BTgkbgR1LSOYuZFcxLwGbvnTPb6-T6WHC9LbwA/viewform?fbzx=8861905125589284430' target='_blank' rel='noreffer' className='lexend font-medium text-[28px] leading-[35px] text-bgPrimary text-center w-[288px] h-[86px] mx-auto bg-primary flex items-center justify-center my-4 cursor-pointer' style={{ boxShadow: `-5px 5px 0px #ADAEFF` }}>
                Get Early Access
            </a>
