            ...
            <div className="flex flex-col items-center justify-center mt-[-32px]">
                <div className="rounded-2xl flex items-center justify-evenly flex-col bg-bgPrimary gap-6 p-10 w-[410px] height[600px]">
                    ...
                    <div className="flex flex-col items-center justify-center w-full gap-1">
                        <h1 className=" text-[40px] leading-[50px] text-textDark font-bold lexend whitespace-nowrap">Claim Username</h1>
                        <p className=" lexend font-normal text-textDark text-[16px]">
                    ...
                    <div className="flex flex-col items-center justify-center w-full gap-6">
                        ...
                        <button className={`flex items-center justify-center w-full py-3 font-bold rounded-lg ${claimedUsername.length > 1 ? 'bg-primary' : 'bg-textSecondary'} text-bgPrimary`}>
                            Continue
                        </button>
                    </div>
                </div>
